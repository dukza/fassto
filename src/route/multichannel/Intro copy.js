                ...
                <div className="d-flex flex-column">
                    {
                        shops.map((shop)=>{
                            return(
                            <IndexLink key={shop.id} className="text-decoration-none d-flex align-items-center justify-content-between sectionType" to={`${match.url}/${shop.url}`} key={`/multichannel/${shop.id}`}>
                                <div className="d-flex flex-column ">
